...
public class RefreshExternalCollectionReq {
    ...
    private final JsonObject externalSpec;

    private RefreshExternalCollectionReq(RefreshExternalCollectionReqBuilder builder) {
        this.databaseName = builder.databaseName;
        this.collectionName = builder.collectionName;
        this.externalSource = builder.externalSource != null ? builder.externalSource : "";
    ...
    public String toString() {
        return "RefreshExternalCollectionReq{" +
