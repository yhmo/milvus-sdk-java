...
/**
 * Request parameters for the {@code getPersistentSegmentInfo} API.
 */
...
public class GetPersistentSegmentInfoReq {
    ...
    /**
     * Creates a new builder for {@code GetPersistentSegmentInfoReq}.
     *
     * @return the builder
     */
    ...
    /**
     * Builder for {@link GetPersistentSegmentInfoReq} class.
     */
    ...
    public static class GetPersistentSegmentInfoReqBuilder {
        ...
        /**
         * Builds the {@code GetPersistentSegmentInfoReq}.
         *
         * @return the constructed {@code GetPersistentSegmentInfoReq}
         */
