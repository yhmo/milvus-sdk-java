...
class CollectionDockerTest extends MilvusV2DockerTestBase {
    ...
    void testOperationsAcrossDB() {
        ...
        // drop the temp database so the shared standalone is left clean for other classes
    ...
    void testDocInOut() {
        ...
        Assertions.assertTrue(fieldSchema.getEnableMatch());
    ...
    void testAlterCollection() {
        ...
        Map<String, String> properties = new HashMap<>();
        properties.put("ttl.seconds", "300");
        ...
        DescribeCollectionResp descResp = client.describeCollection(DescribeCollectionReq.builder()
                .collectionName(collectionName)
                .build());
        Assertions.assertEquals("300", descResp.getProperties().get("ttl.seconds"));
